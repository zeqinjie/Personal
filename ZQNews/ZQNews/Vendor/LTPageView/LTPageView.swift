...
let NORMAL_BASE_COLOR: UIColor = UIColor(r: 102, g: 102, b: 102)
let SELECT_BASE_COLOR: UIColor = UIColor(r: 34, g: 34, b: 34)
//public let glt_iphoneX = (UIScreen.main.bounds.height == 812.0)

@objc public enum LTLayoutType:Int {
    case LTLayoutDefalt   //默认
}
...
public class LTLayout: NSObject {
    ...
    /* pageView背景颜色 */
    @objc public var titleViewBgColor: UIColor? = ZQColor_ffffff!
    ...
    @objc public var bottomLineColor: UIColor? = ZQColor_ff8000!
    ...
    /* 是否从titleView开始算scrollview */
    @objc public var isCaculatorScrollFromTitleY: Bool = false
    
    /* pageView底部线的高度 */
    @objc public var pageBottomLineHeight: CGFloat = 0.5
    
    /* pageView底部线的颜色 */
    @objc public var pageBottomLineColor: UIColor? = ZQColor_e2e2e2!
    ...
    /* 默认类型*/
    @objc public var layoutType = LTLayoutType.LTLayoutDefalt
...
public typealias PageViewButtonClickBlock = (UIButton) -> Void
...
public class LTPageView: UIView {
    ...
    @objc public var buttonClickBlock: PageViewButtonClickBlock?
    ...
    public lazy var pageTitleView: UIView = {
        var pageTitleViewWidth = self.bounds.width
        var pageTitleViewX:CGFloat = 0
        let pageTitleView = UIView(frame: CGRect(x: pageTitleViewX, y: 0, width: pageTitleViewWidth, height: self.layout.sliderHeight))
    ...
    private lazy var pageBottomLineView: UIView = {
        var x:CGFloat = 0
        let pageBottomLineView = UIView(frame: CGRect(x: x, y: self.pageTitleView.bounds.height - (self.layout.pageBottomLineHeight), width: self.bounds.width, height: self.layout.pageBottomLineHeight))
    ...
    private lazy var scrollView: UIScrollView = {
        ...
        if layout.isCaculatorScrollFromTitleY {
            scrollViewY = layout.sliderHeight
        }
        let scrollView = UIScrollView(frame: CGRect(x: 0, y: scrollViewY, width: self.bounds.width, height: self.bounds.height - scrollViewY))
    ...
    @objc public init(frame: CGRect, currentViewController: UIViewController, viewControllers:[UIViewController], titles: [String], layout: LTLayout) {
        ...
        pageBottomLineView.isHidden = layout.isHiddenPageBottomLine
...
extension LTPageView {
    ...
    private func createViewController(_ index: Int)  {
        ...
        var viewControllerY: CGFloat = 0.0 //layout.sliderHeight
